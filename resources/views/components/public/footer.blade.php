                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="wt-footerlogohold">
                        <strong class="wt-logo">
                            <a href="{{ route("public.home") }}"><img src="{{asset("img/content/logo-light.svg")}}" alt="company logo here"></a>
                        </strong>
                        <div class="wt-description">
                            <p>Artisan's mission is to change how the world works together. Artisan connects businesses with freelancers offering digital services in 30+ categories.</p>
                        </div>
