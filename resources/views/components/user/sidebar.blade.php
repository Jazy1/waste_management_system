        ...
        <div class="sidebar__top">
            <div class="container container--sm">
                <a class="sidebar__logo" href="{{ route('user.dashboard') }}">
                    <div class="sidebar__logo-text"> User</div>
                </a>
            </div>
        </div>
            ...
            <nav class="sidebar__nav">
                <ul class="sidebar__menu">
                    ...
                    <li class="sidebar__menu-item">
                        <a class="sidebar__link " href="{{ route('user.dashboard') }}" aria-expanded="true">
                    ...
                    <li class="sidebar__menu-item">
                        <a class="sidebar__link" data-toggle="collapse" data-target="#scraps"
                            aria-expanded="false">
                            <span class="sidebar__link-icon">
                                <i class="fa-solid fa-sack-xmark"></i>
                            </span>
                            <span class="sidebar__link-text">Scraps</span>
                            <span class="sidebar__link-arrow">
                                <svg class="icon-icon-keyboard-down">
                                    <use xlink:href="#icon-keyboard-down"></use>
                                </svg>
                        ...
                        <div class="collapse" id="scraps">
                            <ul class="sidebar__collapse-menu">
                                <li class="sidebar__menu-item">
                                    <a class="sidebar__link" href="
                                    {{ route("users.scraps.index") }}
                                    ">
                                        <span class="sidebar__link-signal"></span>
                                        <span class="sidebar__link-text">Dashboard</span>
                                    </a>
                                ...
                                <li class="sidebar__menu-item">
                                    <a class="sidebar__link" href="
                                    {{ route("users.scraps.create") }}
                                    ">
                                        <span class="sidebar__link-signal"></span>
                                        <span class="sidebar__link-text">Add new listing</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
