		...
		<div class="container">
			<div class="row justify-content-md-center">
				<div class="col-xs-12 col-sm-12 col-md-8 push-md-2 col-lg-6 push-lg-3">
					...
					<div class="wt-title"><h2>Gig</h2></div>
					<ol class="wt-breadcrumb">
						<li><a href="{{route("public.home")}}">Home</a></li>
						{{-- @if(session()->has('url.previous'))
							<li><a href="{{ session('url.previous') }}">Gigs</a></li>
						@endif --}}
						<li class="wt-active"><a href="{{request()->url()}}"></a> Gig</li>
					</ol>
					</div>
				</div>
			</div>
...
@section('content')
					...
					<div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
						...
						<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-left">
							<div class="wt-proposalholder">
								...
								<div class="wt-btnarea"><a href="{{ route("orders.create", ["gigId"=> $gig->id]) }}"  class="wt-btn" {{$gig->status == "active" ? "disabled" : "" }} >Place Order</a></div>
							</div>
						</div>
								...
								<div class="wt-widget wt-companysinfo-jobsingle">
									<div class="wt-companysdetails">
										...
										<div class="wt-companysinfo">
											<figure><img src="{{asset($gig->freelancer->img)}}" alt="img description"></figure>
											<div class="wt-title">
												<a href="javascript:void(0);"><i class="fa fa-check-circle"></i> Verified Freelancer</a>
												<h2>{{ $gig->freelancer->name }}</h2>
											</div>
											<ul class="wt-postarticlemeta">
												<li>
													<a >
														<span>{{$gig->status == "active" ? "Open Gig" : "Closed Gig" }}</span>
													</a>
												</li>
												<li>
													<a href="{{ route('public.freelancer.show', ['id' => $gig->freelancer->id]) }}">
														<span>Profile</span>
													</a>
												</li>
	...
	<script>
		function placeOrder(gigId) {
			window.location.href = `order/place/${gigId}`;
		}
	</script>
@endsection
