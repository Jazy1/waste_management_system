...
@section('title', 'Collectors | Admin')
    ...
    <main class="page-content">
        <div class="container">
            ...
            <div class="page-header">
                <h1 class="page-header__title">Collectors</h1>
            </div>
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('admin.collectors.index') }}">
                                                                        ...
                                                                        <ul class="dropdown-items__list">
                                                                            ...
                                                                            <li class="dropdown-items__item">
                                                                                <a target="_blank"
                                                                                    ...
                                                                                    href="
                                                                                    {{-- {{ route("public.freelancer.show", ["id" => $freelancer->id]) }} --}}
                                                                                    {{ route("admin.collectors.account") }}
                                                                                    ">
                                                                                    <span class="dropdown-items__link-icon">
