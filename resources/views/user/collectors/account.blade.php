    ...
    <main class="page-content page-content--order-header">
        <div class="container">
            <div class="page-header">
                <h3 class="page-header__subtitle d-lg-none">Collectors Details</h3>
                <h1 class="page-header__title">Collector ID <span class="text-grey">#1010
                    {{-- {{$order->number}} --}}
                </span></h1>
            </div>
                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item "><a class="breadcrumbs__link"
                                        href="{{ route("admin.collectors.index") }}"><span>Collectors</span>
                                        <svg class="icon-icon-keyboard-right breadcrumbs__arrow">
                                            <use xlink:href="#icon-keyboard-right"></use>
                                        </svg></a>
                                </li>
                                <li class="breadcrumbs__item active"><span class="breadcrumbs__link">Collector #1010</span>
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="card__container">
                            <div class="card__header">
                                <div class="row gutter-bottom-xs justify-content-between flex-grow-1">
                                    <div class="col">
                                        <h3 class="card__title">Collector</h3>
                                    </div>
                    ...
                    <section class="card-order__section card-order__method">
                        <div class="card__container">
                            <div class="row gutter-bottom-sm">
                                <div class="col">
                                    <h3 class="card__title">Collector Details</h3>
                                ...
                                <div class="col-12 col-sm-10 col-md-8 col-xl card-order__method-status">
                                    ...
                                    <div class="card-order__shipping">
                                        <div class="form-group">
                                            {{-- {{$order->description}} --}}
                                            Koray wala is professional koray wala guy who gets trash proficiently and efficiently. His main expertise lies in dealing with banana peels.
                                            {{-- <div class="input-group input-group--append">
                                                <select
