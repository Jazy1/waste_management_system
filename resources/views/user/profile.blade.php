                        ...
                        <div class="breadcrumbs__container">
                            <ol class="breadcrumbs__list">
                                ...
                                <li class="breadcrumbs__item active">
                                    <a class="breadcrumbs__link" href="{{ route('user.profile') }}">
                                        <span>Profile</span>
                                    </a>
                                </li>
                        ...
                        <div class="card__container">
                            <div class="card__header">
                                <div class="card__header-left">
                                    <h3 class="card__header-title">User Info</h3>
                                </div>
                            ...
                            <div class="card__body">
                                ...
                                <div class="customer-profile__avatar" style="overflow: hidden">
                                    <img src="
                                        ...
                                        " alt="" style="border-radius: 10px;height: -webkit-fill-available;">
                                ...
                                <h4 class="customer-profile__title">
                                    {{-- {{ $admin->name }} --}}
                                    User
                                </h4>
                                    ...
                                    <div class="credit-card">
                                        ...
                                        <div class="credit-card__content">
                                            <input class="credit-card__number" type="text"
                                                value="69696969{{-- {{ $bankAccount->card_number }} --}}" readonly="readonly">
                                            <div class="credit-card__name">
                                                {{-- {{ $bankAccount->card_holder }} --}}
                                                Mustaqeem
                                            </div>
                                            <div class="credit-card__date">
                                                {{-- {{ $bankAccount->card_expiry }} --}}
                                                26/69
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            ...
                                            " id="infoForm" enctype="multipart/form-data">
                                                @csrf
                                                @method("PUT")
                                                <div class="modal__body">
                                                    <div class="modal__container">
                                                        <div class="modal-account__upload profile-upload js-profile-upload">
                                                            ...
                                                            <svg class="profile-upload__thumbnail" viewBox="0 0 252 272" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                                                ...
                                                                <defs>
                                                                    ...
                                                                    <image id="profileImageAddPlaceholder" width="700" height="700" xlink:href="{{ asset("img/profile-pictures/default.svg") }}
                                                                    "></image>
                                                                    {{-- {{ asset("img/content/upload-placeholder.svg") }} --}}
                                                                    <image id="profileImageAddPlaceholder" width="700" height="700" xlink:href="{{ asset("img/profile-pictures/default.svg") }}
                                                                    "></image>
                                                                    {{-- {{ asset($admin->img ) }} --}}
                                                                    <image id="profileImageAdd" class="profile-upload__image" width="700" height="700" xlink:href="
                                                                    {{ asset("img/profile-pictures/default.svg") }}"></image>
                                                                    {{-- {{ asset($admin->img ) }} --}}
                                                                </defs>
                                                            </svg>
                                                        ...
                                                        <div class="space-upNdown input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="text" name="name" value="Mustaqeeeeeeeem" placeholder="Name">
                                                            {{-- {{ $admin->name }} --}}
                                                        </div>
                            ...
                            <div class="simplebar-content" style="padding: 0px;">
                                ...
                                <div class="modal__wrap">
                                    <div class="modal__window">
                                        <div class="modal__content">
                                            <div class="modal__body">
                                                <form id="bankAccountForm" action="
                                                {{-- {{ route("admin.bank_account.update", ['id' => $admin->id]) }} --}}
                                                " method="POST">
                                                    @method("PUT")
                                                    @csrf
                                                    ...
                                                    <div class="modal__container">
                                                        ...
                                                        <div class="space-upNdown input-group input-group--append input-group--append-lg">
                                                            ...
                                                            <input class="input js-card-number" type="text" value="
                                                            {{-- {{ $bankAccount->card_number }} --}}
                                                            " placeholder="**** **** **** 1234" name="card_number" required>
                                                        </div>
                                                        ...
                                                        <div class="space-upNdown  input-group input-group--white input-group--prepend">
                                                            ...
                                                            <input class="input" type="numeric" placeholder="Account Number" 
                                                            {{-- value="
                                                            {{ $bankAccount->account_number }}
                                                            "  --}}
